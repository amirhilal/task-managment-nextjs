...
import { FiLayers, FiPlus, FiColumns } from 'react-icons/fi';
          ...
          <div className="container mx-auto px-6 py-8">
            {activeTab === 'dashboard' && (
              <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-2xl font-bold mb-4 text-gray-800">Welcome to the Admin Dashboard</h2>
                <p className="text-gray-700">Here you can manage your projects and columns.</p>
            ...
            {activeTab === 'projects' && (
              <>
                <div className="bg-white shadow rounded-lg p-6 mb-6">
                  ...
                  <form onSubmit={handleCreateProject} className="flex items-center">
                    <input
                      type="text"
                  ...
                  {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                      {projects.map((project) => (
                        <div key={project._id} className="bg-white overflow-hidden shadow rounded-lg border border-gray-200">
